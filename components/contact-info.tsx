...
export function ContactInfo() {
  return (
    <div className="space-y-8">
      <h2 className="text-3xl font-oswald text-brand-navy uppercase mb-6">Get In Touch</h2>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/80">
                    <a href="tel:+15085555555" className="hover:text-brand-gold transition-colors">
                      (508) 555-5555
                    </a>
                  </p>
                </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/80">
                    <a href="mailto:info@stormalong.com" className="hover:text-brand-gold transition-colors">
                      info@stormalong.com
                    </a>
                  </p>
                </div>
      ...
      <div className="bg-amber-50 rounded-lg p-6 border border-amber-100">
        <h3 className="font-oswald text-xl text-brand-navy uppercase mb-3">Distribution Inquiries</h3>
        <p className="text-gray-700 mb-4">
          Interested in carrying Stormalong Cider at your establishment? We'd love to hear from you!
        </p>
