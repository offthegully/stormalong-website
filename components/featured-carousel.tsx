  ...
  return (
    <section className="py-16 bg-white">
      <div className="stormalong-container">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-oswald text-brand-navy uppercase mb-4">Featured Ciders</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover our most popular craft ciders, made with 100% fresh-pressed apples and natural ingredients. Each
            cider tells a unique story of flavor and tradition.
          </p>
        </motion.div>
        ...
        >
          <CarouselContent className="-ml-2 md:-ml-4">
            {featuredCiders.map((cider, index) => (
              <CarouselItem key={cider.id} className="pl-2 md:pl-4 sm:basis-1/2 md:basis-1/3 lg:basis-1/4">
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <Card className="overflow-hidden border-none shadow-md hover:shadow-lg transition-shadow duration-300">
                    <CardContent className="p-0">
                      ...
                      <div className="p-4">
                        <h3 className="font-oswald text-xl text-brand-navy uppercase mb-1">{cider.name}</h3>
                        <p className="text-sm text-gray-600 mb-3 line-clamp-2">{cider.tagline}</p>
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-medium text-gray-500">{cider.abv}% ABV</span>
                          <span
                            className={cn(
                        ...
                        <Link href={`/ciders/${cider.slug}`} className="mt-3 block">
                          <motion.div
